...
Global RegexStringNicks := "i)INFO Client [0-9]*\] #.*: .*("

Loop, Read, Assets/nicknames.txt
{
	RegexStringNicks := RegexStringNicks . A_LoopReadLine . "|"
}
StringTrimRight, RegexStringNicks, RegexStringNicks, 1
RegexStringNicks := RegexStringNicks . ")"
...
{
	RegexStringEvent := RegexStringEvent . A_LoopReadLine . "|"
}
StringTrimRight, RegexStringEvent, RegexStringEvent, 1
RegexStringEvent := RegexStringEvent . ")"
